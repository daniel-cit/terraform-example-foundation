...
variable "base_private_service_cidr" {
  description = "Base network private service CIDR range."
  type        = string
}

variable "base_subnet_primary_ranges" {
  description = "Base network primary subnet ranges."
  type        = map(string)
}

variable "base_subnet_secondary_ranges" {
  description = "Base network secondary subnet ranges."
  type        = map(list(map(string)))
}

variable "restricted_private_service_cidr" {
  description = "Restricted network private service CIDR range."
  type        = string
}

variable "restricted_subnet_primary_ranges" {
  description = "Restricted network primary subnet ranges."
  type        = map(string)
}
